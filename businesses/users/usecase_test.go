...
import (
	...
	user "erdmaze/businesses/users"
	userMock "erdmaze/businesses/users/mocks"
...
func TestGetById(t *testing.T) {
	t.Run("test case 1, valid test ", func(t *testing.T) {
		domain := user.Domain{
			Id:       1,
			Fullname: "Novien Ghoziana",
			Username: "novien",
			Email:    "novienghi@gmail.com",
		}
...
func TestLogin(t *testing.T) {
	t.Run("test case 1, valid test", func(t *testing.T) {
		...
		_, err := userUsecase.Login(context.Background(), "novien", "12345")
		assert.Nil(t, err)
	})
	t.Run("test case 2, password error", func(t *testing.T) {
		...
		_, err := userUsecase.Login(context.Background(), "novien", "1234567")
	...
	t.Run("test case 3, error record", func(t *testing.T) {
		...
		result, err := userUsecase.Login(context.Background(), "novienzi", "12345")
