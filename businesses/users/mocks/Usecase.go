...
import (
	context "context"
	users "erdmaze/businesses/users"
...
func (_m *Usecase) GetByID(ctx context.Context, newsId int) (users.Domain, error) {
...
func (_m *Usecase) Login(ctx context.Context, username string, password string) (string, error) {
